...
import com.rakibul.onlinedailygroceries.model.PostBlog2;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;

public class BlogAdapter2 extends RecyclerView.Adapter<BlogAdapter2.ViewHolder>{

    ArrayList<PostBlog2> list;
    Activity activity;

    public BlogAdapter2(ArrayList<PostBlog2> list, Activity activity) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.product_layout2, parent, false);
